...
interface MediaFileData {
    ...
    The value is zero for audio clips. */
    height: number;
    /** The width of the image or video in pixels.
    The value is zero for audio clips. */
    width: number;
    /** The length of the video or sound clip in seconds.
    The value is zero for images. */
    duration: number;
}

/** Encapsulates the error code resulting from
a failed media capture operation. */
export interface CaptureError {
     ...
     *         The camera or audio capture application is currently
     *         serving another capture request.
     *     CaptureError.CAPTURE_INVALID_ARGUMENT
     *         Invalid use of the API (e.g., the value of limit
     *         is less than one).
     *     CaptureError.CAPTURE_NO_MEDIA_FILES
     *         The user exits the camera or audio capture application
...
interface AudioOptions {
    /**
     * The maximum number of audio clips the device's user
     * can capture in a single
...
interface ImageOptions {
    /**
     * The maximum number of images the user can capture in
...
interface VideoOptions {
    /**
     * The maximum number of video clips the device's user
     * can capture in a single
     * capture operation. The value must be greater than or equal to 1.
     */
    limit?: number;
...
interface ConfigurationData {
    ...
    type: string;
    /** The height of the image or video in pixels.
    The value is zero for sound clips. */
    height: number;
    /** The width of the image or video in pixels.
    The value is zero for sound clips. */
    width: number;
...
export interface MediaFile {
     ...
     * @param successCallback Invoked with a MediaFileData object when
     * successful.
...
/** This plugin provides access to the device's audio,
...
export interface Capture {
     ...
     * @param onSuccess Executes when the capture operation finishes
     *  with an array
     *                  of MediaFile objects describing each captured
     *                  audio clip file.
     * @param onError   Executes, if the user terminates the operation
     * before an audio clip is captured,
     *                  with a CaptureError object, featuring the
